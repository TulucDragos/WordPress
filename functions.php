...
function onpiste_styles()
{
  ...
  if(is_page('Log In') || is_page('Non-Partner') || is_page('Validate') || is_page('Thank You') || is_page('Not Validated') || is_page('Existing Code') || is_page('Partner'))
  {
